/* * * * * * * * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * *
 * msegstd.cpp: MSEG Standard mode class	                          *
 * Version: 0.9.x                                                         *
...
int Standard_Mode::firstpass(Level& pass1, ERS_Image& Img, MSEG_Init& mseg, float level_ID, MSEG_Param& Param){
...
int Standard_Mode::firstpass(Level& pass1, ERS_Image& Img, MSEG_Init& mseg, float level_ID, MSEG_Param& Param, Level& super_level){
...
int Standard_Mode::secondpass(Level& pass2, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass){
...
int Standard_Mode::secondpass(Level& pass2, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass, Level& super_level){
...
int Standard_Mode::nthpass(Level& passn, ERS_Image& Img, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level){
...
int Standard_Mode::nthpass(Level& passn, ERS_Image& Img, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level, Level& super_level){
...
int Standard_Mode::nthpass(Level& passn, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass){
...
int Standard_Mode::nthpass(Level& passn, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass, Level& super_level){
