/* * * * * * * * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * *
 * msegslow.h: MSEG Slow mode class	                        	  *
 * Version: 0.9.x                                                         *
...
#include "msegcore.h"
	...
	class Slow_Mode{
	    public:
     	...
     	int nthpass(Level& passn, ERS_Image& Img, Texture_Image& TexImg, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level);
     	int nthpass(Level& passn, ERS_Image& Img, Texture_Image& TexImg, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level, Level& super_level);
     	int nthpass(Level& passn, ERS_Image& Img, Texture_Image& TexImg, MSEG_Init& mseg, Level& previous_pass);
     	int nthpass(Level& passn, ERS_Image& Img, Texture_Image& TexImg, MSEG_Init& mseg, Level& previous_pass, Level& super_level);
	};//Slow_Mode End
