/* * * * * * * * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * *
 * msegfastest.cpp: MSEG Fastest mode class                               *
 * Version: 0.9.x                                                         *
...
int Fastest_Mode::firstpass(Level& pass1, ERS_Image& Img, MSEG_Init& mseg, float level_ID, MSEG_Param& Param){
...
int Fastest_Mode::firstpass(Level& pass1, ERS_Image& Img, MSEG_Init& mseg, float level_ID, MSEG_Param& Param, Level& super_level){
...
int Fastest_Mode::secondpass(Level& pass2, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass){
...
int Fastest_Mode::secondpass(Level& pass2, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass, Level& super_level){
...
int Fastest_Mode::nthpass(Level& passn, ERS_Image& Img, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level){
...
int Fastest_Mode::nthpass(Level& passn, ERS_Image& Img, float level_ID, MSEG_Init& mseg, MSEG_Param& Param, Level& sub_level, Level& super_level){
...
int Fastest_Mode::nthpass(Level& passn, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass){
...
int Fastest_Mode::nthpass(Level& passn, ERS_Image& Img, MSEG_Init& mseg, Level& previous_pass, Level& super_level){
